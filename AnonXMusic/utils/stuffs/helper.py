...
ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ : /'''
    HELP_ChatGPT = '''<b>ꜰᴏɴᴛ ꜱʏꜱᴛᴇᴍ</b>

<b>— ᴜꜱᴇ</b> <code>/font [ᴛᴇxᴛ]</code> <b>ᴛᴏ ɢᴇɴᴇʀᴀᴛᴇ ꜰᴀɴᴄʏ ꜰᴏɴᴛ ꜱᴛʏʟᴇꜱ ᴏꜰ ʏᴏᴜʀ ᴛᴇxᴛ.</b>  
<b>— ʙᴏᴛ ᴡɪʟʟ ʀᴇᴘʟʏ ᴡɪᴛʜ ᴍᴜʟᴛɪᴘʟᴇ ꜰᴏɴᴛ ᴠᴀʀɪᴀᴛɪᴏɴꜱ.</b>
...
/kang ➠ ᴄʀᴇᴀᴛᴇs ᴀ ᴘᴀᴄᴋ ᴏғ sᴛɪᴄᴋᴇʀs ғʀᴏᴍ ᴀ ᴏᴛʜᴇʀ ᴘᴀᴄᴋ.
